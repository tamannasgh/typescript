var num = 10; //number (let a:number;)
var str = "tamanna"; //string (let str: string;)
var bool = true; //boolean (let bool: boolean;)
var arr = [1, 2, 3, "tamanna", { name: "tamanna" }]; //arr of string or number or object which have a prop name of typr string
//if we want to say we want an array of numbers ONLY
var numArr = [1, 2, 3]; //we are explicitly saying that this numArr is number of array (number[])
var user = { name: "tamanna", age: 18 };
...
var tup = ["tamanna", 18]; //tis is a tuple that has only 2 elements first is of type string and second of type number
//its full of error that saying something like block scope we will come to thiss soonnn
var badPractice; //any let badPractice:any;
badPractice = 5;
badPractice = "hehe";
...
var welcome = print(); //if i hover to the welcome variable its showing the type void.
var statusCodes;
